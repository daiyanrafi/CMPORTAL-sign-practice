...
import { DetailsList, DetailsListLayoutMode, SelectionMode, Stack, PrimaryButton } from '@fluentui/react';
import EditPage from './EditPage';
...
interface JsonTableProps {
  ...
  onEditClick: (rowId: string | null) => void; // Update type to accept null
...
const JsonTable: React.FC<JsonTableProps> = ({ bookings, editingRow, onEditClick, onSave }) => {
  const renderActionColumn = (item: BookingData): React.ReactElement => (
    <PrimaryButton onClick={() => onEditClick(item.bookableresourcebookingid)}>Edit</PrimaryButton>
  );
