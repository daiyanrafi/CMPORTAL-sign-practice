...
const policies: Row[] = [
  ...
  { id: 2, label: 'Row 2', content: '1.4 Workplace Anti-Bullying Harassment and Discrimination Policy 2023' },
  { id: 3, label: 'Row 2', content: '3.2.1 Financial Authorities and Delegations Policy 2023' },
  { id: 4, label: 'Row 2', content: '3.2.1a 1.5 Target Cash Policy 2023' },
  { id: 5, label: 'Row 2', content: '5.1.1 Document Retention and Destruction Policy 2021' },
